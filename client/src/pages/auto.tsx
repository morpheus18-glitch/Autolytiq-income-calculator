    ...
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden">
      ...
      <main className="max-w-[1800px] mx-auto px-4 lg:px-8 xl:px-16 2xl:px-24 py-8">
        ...
        <div className="grid lg:grid-cols-5 gap-6 mb-8">
          ...
          >
            {/* Hero CTA Card */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/20 via-blue-500/10 to-primary/10 border-2 border-blue-500/30 p-6 shadow-xl">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/20 border border-blue-500/30 mb-4">
                  ...
                  <span className="text-xs font-semibold text-blue-400">12% Rule Calculator</span>
                </div>

                <h3 className="text-2xl font-bold mb-2">
                  Know Your <span className="text-blue-400">Max Budget</span>
                </h3>
                <p className="text-muted-foreground text-sm mb-5">
                  Calculate exactly how much car you can afford without straining your finances.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 mb-5">
                  <div className="p-3 rounded-xl bg-background/60 backdrop-blur-sm border border-border/50">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-muted-foreground">Max Payment</span>
                    </div>
                    <div className="text-lg font-bold text-blue-400">12%</div>
                    <div className="text-[10px] text-muted-foreground">of gross income</div>
                  </div>
                  <div className="p-3 rounded-xl bg-background/60 backdrop-blur-sm border border-border/50">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="text-sm font-bold text-emerald-400">Included</div>
                    <div className="text-[10px] text-muted-foreground">in calculation</div>
                  </div>
                  <div className="p-3 rounded-xl bg-background/60 backdrop-blur-sm border border-border/50">
                    <div className="flex items-center gap-2 mb-1">
                      <div className="w-2 h-2 rounded-full bg-yellow-500" />
                      <span className="text-xs text-muted-foreground">Tax & Fees</span>
                    </div>
                  ...
                  <div className="p-3 rounded-xl bg-background/60 backdrop-blur-sm border border-border/50">
                    ...
                    <div className="text-sm font-bold">APR by Score</div>
                  </div>
                </div>

                {/* Arrow pointing to calculator */}
                <div className="hidden lg:flex items-center gap-2 text-blue-400">
            ...
            <Card className="glass-card border-none shadow-lg">
              ...
              <CardContent className="pb-4">
                <div className="space-y-2">
                  {SHOPPING_TIPS.slice(0, 2).map((section, index) => (
                    <motion.div
                      key={section.title}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-muted-foreground leading-tight">{section.tips[0]}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
          ...
          {/* RIGHT: Affordability Calculator */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <Card className="glass-card border-2 border-blue-500/20 shadow-2xl shadow-blue-500/5 overflow-hidden">
              <CardHeader className="pb-3 bg-gradient-to-r from-blue-500/5 to-transparent">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg flex items-center gap-2">
                    <div className="p-1.5 rounded-lg bg-blue-500/10">
                      <DollarIcon className="h-5 w-5 text-blue-500" />
                    </div>
